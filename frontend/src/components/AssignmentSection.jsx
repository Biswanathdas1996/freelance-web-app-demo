...
export default function AssignmentSection({ projectId, isProjectOwner }) {
  ...
  const [editForm, setEditForm] = useState({ freelancerName: '', description: '', notes: '', currentStage: 'NotStarted' });
  ...
  const validateEdit = () => {
    ...
    if (editForm.description && editForm.description.trim().length < 10)
      e.description = 'Description must be at least 10 characters';
    if (!editForm.currentStage) e.currentStage = 'Stage is required';
    return e;
  };
  ...
  const handleEditCancel = () => {
    setEditMode(false);
    setEditForm({ freelancerName: '', description: '', notes: '', currentStage: 'NotStarted' });
    setEditErrors({});
  };
          ...
          <form onSubmit={handleEditSubmit}>
            ...
            <div className="form-group">
              ...
              {editErrors.description && (
                <div className="error-msg">{editErrors.description}</div>
              )}
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              {editErrors.currentStage && (
                <div className="error-msg">{editErrors.currentStage}</div>
              )}
            </div>
            {editErrors.submit && (
              <div className="error-msg" style={{ marginBottom: 8 }}>
